...
#include "CTestPlayPawn.h"

// Sets default values
ACTestPlayPawn::ACTestPlayPawn()
{
...
*/
	...
	// Camera의 부모 Compoennt로 Mesh 지정한다. (자체엔진의 AddChild 기능)
	...
	// 그전에 만들어진 얘는 안보임. 생성자는 객체가 생성될 떄 호출되기 때문.
	// 
...
// Called every frame
void ACTestPlayPawn::Tick(float DeltaTime)
{
...
void ACTestPlayPawn::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
